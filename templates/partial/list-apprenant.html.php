<div class="card-before mb-15">
    <div>
        <h4>Apprenants: <span style="color: #009187;">Promotion 6</span></h4>
    </div>
    <div>
...
<div class="card-app p-25">
    ...
    <div class="form-content">
        <h4 class="mb-15 ml-15" style="position:absolute; top:15.4em;" >Promotion</h4>
        <div class="ml-16 d-flex-s-between-align-i-center" style="margin-right: 15px">
            <h5>Liste des Apprenants <span class="color-success">(50)</span></h5>
            <div  >
        ...
        <div class="ml-15 mt-10">
            <a href="#"><img src="../public/images/file-in-folder.jpeg" alt="folder" width="4%"></a>
        </div>
                ...
                <table style="width: 100%;">
                    ...
                    <tbody  >
                        ...
                        <tr style="text-align: center">
                            <td style="padding: 15px 0;"><i class="fas fa-user" style="font-size: 1.7rem"></i></td>
                            <td><?=$app['nom']?></td>
                            <td><?=$app['prenom']?></td>
                            <td><?=$app['email']?></td>
                            <td><?=$app['genre']?></td>
    ...
    <div class="mt-10 ml-15">
        <h4 style="position:absolute; top:50.7em;" >Référentiels</h4>
    </div>
    </div>
</div>
